<script>
import { getProductDetail, getProComments } from '@/api/product'
  ...
  <div class="info">
    <div class="title">
      <div class="price">
        ...
        <span class="sellcount">已售{{ detail.goods_sales }}</span>
      </div>
    </div>
    ...
    <div class="footer">
      ...
      <div @click="buyFn" class="btn-add">立刻购买</div>
    </div>
    <van-action-sheet v-model="showPannel" :title="mode === 'cart' ? '加入购物车' : '立即购买'">
      <div class="product">
        ...
        <div class="showbtn" v-if="detail.stock_total > 0">
          <button class="btn" v-if="mode==='cart'" @click="addCart">加入购物车</button>
